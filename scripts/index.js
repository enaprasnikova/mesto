...
function submitInfo(evt) {
  evt.preventDefault();
  let inputNameElement = document.querySelector('.popup__input-text_name');
  let inputAboutMeElement = document.querySelector('.popup__input-text_about-me');
...
function openPopUp() {
  ...
  let inputName = popUp.querySelector('.popup__input-text_name');
  let inputAboutMe = popUp.querySelector('.popup__input-text_about-me');
